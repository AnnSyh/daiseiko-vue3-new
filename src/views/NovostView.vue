<template>
	<article>
		<div>
			<div class="block panel panel-theme-light article-header pt-16 pb-16">
				<div class="container mx-auto px-4 sm:px-6 lg:px-8">
					<div class="mx-auto text-center max-w-6xl">
						<h1>Новогодние Наборы Forlle’d и Nimue</h1>
						<div class="text-center">
							<p class="text-base mb-0 font-medium text-gray-600">
								14 ноября 2024
							</p>
						</div>
					</div>
		...
		<div class="container lg:max-w-4xl lg:px-12">
			...
			<div class="article-content panel panel-theme-default">
				<div class="lead">
					Эксклюзивные новинки юбилейного года, которые поступят в продажу в конце года, и бестселлеры
					брендов.
				</div>
				<div>
					<p> В каждом наборе - эксклюзивный ювелирный аксессуар ручной работы из натурального камня
						Змеевика, символа года, который исполнит ваши мечты. Украшение венчает сильный
					...
					<ul>
						<li> Реструктурирующая и выравнивающая тон кожи сыворотка с витамином С,30
							млNEW </li>
						<li> Крем для губ Hyalogy Protective cream for lips, 9 г </li>
						<li> Маска для век Hyalogy P-effect sheet, 1 пара </li>
					...
					<ul>
						<li> Сыворотка для кожи вокруг глаз, 15мл </li>
					...
					<p> По вопросам приобретения обращайтесь, пожалуйста, к торговым представителям бренда или
						по телефонам компании в офисы ООО «Дайсэйко». </p>
				</div>
			</div>
		</div>
	</article>
